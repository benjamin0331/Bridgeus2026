...
使用方式：
    python scripts/build_knowledge_base.py --collection nuclear_energy_all --data-dir data/nuclear_energy
...
# 讓 scripts/ 可以 import 專案根目錄下的 core 模組
...
def build_collection(
    ...
    chroma_dir = ensure_chroma_dir_writable(chroma_dir)
...
def main() -> None:
    ...
    print(
        ...
        f"a = DialogueAgent('{args.collection}'); print(a.respond_simple('請介紹這個議題'))\""
    )
