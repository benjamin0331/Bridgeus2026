"""
Django settings for take_a_bridge project.
...
ROOT_URLCONF = 'take_a_bridge.urls'
...
WSGI_APPLICATION = 'take_a_bridge.wsgi.application'
ASGI_APPLICATION = 'take_a_bridge.asgi.application'
...
if USE_REDIS_CACHE:
    ...
    CACHES = {
        'default': {
            ...
            'LOCATION': 'take-a-bridge-local-cache',
        }
    }
